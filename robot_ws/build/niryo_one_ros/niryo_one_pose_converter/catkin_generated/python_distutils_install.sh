...
echo_and_run cd "/home/ubuntu/robot_ws/src/niryo_one_ros/niryo_one_pose_converter"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ubuntu/robot_ws/src/niryo_one_ros/niryo_one_pose_converter/setup.py" \
     \
    build --build-base "/home/ubuntu/robot_ws/build/niryo_one_ros/niryo_one_pose_converter" \
    install \
    --root="${DESTDIR-/}" \
