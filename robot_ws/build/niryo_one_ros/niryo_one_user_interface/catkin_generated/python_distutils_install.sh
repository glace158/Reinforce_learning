...
echo_and_run cd "/home/ubuntu/robot_ws/src/niryo_one_ros/niryo_one_user_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ubuntu/robot_ws/src/niryo_one_ros/niryo_one_user_interface/setup.py" \
     \
    build --build-base "/home/ubuntu/robot_ws/build/niryo_one_ros/niryo_one_user_interface" \
    install \
    --root="${DESTDIR-/}" \
