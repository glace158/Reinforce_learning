...
echo_and_run cd "/home/ubuntu/robot_ws/src/ros_tcp_endpoint"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/ubuntu/robot_ws/build/ros_tcp_endpoint \
    build --build-base "/home/ubuntu/robot_ws/build/ros_tcp_endpoint" \
    install \
    --root="${DESTDIR-/}" \
